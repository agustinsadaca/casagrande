'use client'
const LogoSvg = () => (
  <svg id="Capa_2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 507.89 319.7">
    <defs>
      <style>
        {`          .cls-1 {
      fill: gray;
    ...
    <g id="Capa_1-2" data-name="Capa_1">
      <g id="LOGO">
        <polyline className="cls-2 animate-line1" points="4 168.87 4 4 349.43 4 349.43 48.94" />
        <polyline className="cls-3 animate-line2"
